...
will be documented with verified detail in a future architecture deep-dive. Memory note: a
single Gaussian is ~2000 bytes (~2 GB GPU memory per million Gaussians).
